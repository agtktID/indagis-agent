...
2. User plugins: ``$INDAGIS_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$INDAGIS_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$INDAGIS_HOME/plugins/model-providers/`` if it exists."""
    try:
        from hermes_constants import get_indagis_home

        d = get_indagis_home() / "plugins" / "model-providers"
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple INDAGIS_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$INDAGIS_HOME/plugins/model-providers/<name>/``
    ...
    # 2. User plugins — under $INDAGIS_HOME/plugins/model-providers/<name>/.
