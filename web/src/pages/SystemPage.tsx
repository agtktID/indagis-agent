...
export default function SystemPage() {
  ...
  const applyUpdate = async () => {
    ...
    if (status?.can_update_hermes === false) {
      showToast(
        "Indagis updates are managed outside this dashboard.",
        "success",
      );
      return;
    }
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <ConfirmDialog
        ...
        title="Update Indagis?"
        description={
          updateInfo && updateInfo.behind && updateInfo.behind > 0
            ? `This will run 'indagis update' (${updateInfo.update_command}) and pull ${updateInfo.behind} new commit${updateInfo.behind === 1 ? "" : "s"}. The gateway restarts when the update finishes; the current session keeps its prompt cache until then.`
            : `This will run 'indagis update' (${updateInfo?.update_command ?? "indagis update"}) and restart the gateway when it finishes.`
        }
        ...
        <Card>
          <CardContent className="py-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-3 gap-x-6 text-sm">
              ...
              <div>
                <div className="text-xs uppercase tracking-wider text-muted-foreground">Indagis</div>
                <div className="flex items-center gap-2">
          ...
          <CardContent className="flex flex-col gap-3 py-4">
            ...
            {!portal?.logged_in && (
              <p className="text-xs text-muted-foreground">
                Log in with <span className="font-mono">indagis portal</span>.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 py-4">
            ...
            <ConfirmDialog
              ...
              title="Restore full Indagis backup?"
              description={`This will overwrite your current Indagis configuration, skills, sessions, and data with the contents of ${backupImportLabel(importConfirmTarget)}. This cannot be undone.`}
              destructive
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-muted-foreground max-w-prose">
                    ...
                    returns links to send the Indagis team. Pastes auto-delete
                    after 6 hours.
                  </span>
                </div>
              </div>
