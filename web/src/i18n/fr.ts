...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour Indagis",
    updatingHermes: "Mise à jour de Indagis…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Indagis (parité avec `hermes plugins`).",
