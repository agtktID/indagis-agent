...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        try:
            ...
            return
        env_override = env_with_legacy_alias("INDAGIS_KANBAN_DISPATCH_IN_GATEWAY", "HERMES_KANBAN_DISPATCH_IN_GATEWAY", "").strip().lower()
            ...
            try:
                ...
                if _is_corrupt_board_db_error(exc):
                    ...
                    logger.error(
                        ...
                        "then run `indagis kanban init` if you need a fresh board.",
                        slug,
                        fingerprint[0],
                    )
                    return None
        ...
        def _auto_decompose_tick(auto_decompose_per_tick: int) -> int:
            ...
            for b in boards:
                ...
                prev_env = env_with_legacy_alias("INDAGIS_KANBAN_BOARD", "HERMES_KANBAN_BOARD")
                try:
                ...
                if bad_ticks >= HEALTH_WINDOW:
                    ...
                    if now - last_warn_at >= 300:
                        logger.warning(
                            ...
                            "`indagis kanban list --status ready`.",
                            bad_ticks,
                        )
                        last_warn_at = now
