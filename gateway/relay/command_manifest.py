...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Indagis session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Indagis session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Indagis agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Indagis Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Indagis gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Indagis session in it",
