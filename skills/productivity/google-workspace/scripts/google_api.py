#!/usr/bin/env python3
"""Google Workspace API CLI for Indagis Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Indagis-facing JSON contract and falls back to the Python client
...
from _hermes_home import get_indagis_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Indagis Agent")
