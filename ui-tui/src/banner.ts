...
// Indagis Agent — ASCII wordmark.
//
// Single-accent identity (Cyber Cyan dominant) — no gradient ramp. The word
// reads "INDAGIS" in 6 rows of box-drawing characters. All decorative glyphs
// from the upstream Hermes caduceus have been retired: Indagis is a SOC /
// investigation tool, not a mythological messenger, so the symbol set stays
// restrained.
const LOGO_ART = [
  '  ██╗███╗   ██╗██████╗  █████╗  ██████╗ ██╗███████╗     █████╗  ██████╗ ███████╗███╗   ██╗████████╗',
  '  ██║████╗  ██║██╔══██╗██╔══██╗██╔════╝ ██║██╔════╝    ██╔══██╗██╔════╝ ██╔════╝████╗  ██║╚══██╔══╝',
