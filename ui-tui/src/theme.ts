...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#FFBF00',
  // The classic Indagis navy surfaces are IDENTITY, not derivation drift —
...
// The classic light-mode Indagis look was never hand-authored: for years the
...
//
// Anything we can't decide stays dark — the default Indagis palette
// is the dark one.
...
export function fromSkin(
  ...
  //    base seeds for this polarity. The base's IDENTITY FILLS (Indagis navy
  ...
  // the derived value already carries the identity seeds (e.g. Indagis navy).
  const activeRow =
