...
def _default_registry_path() -> Path:
    return get_indagis_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        self.expected_hermes_home = expected_hermes_home if expected_hermes_home is not None else str(get_indagis_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_hermes_home:
            raise RuntimeError(f"compute host INDAGIS_HOME mismatch: {got_home} != {self.expected_hermes_home}")
