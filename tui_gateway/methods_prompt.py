...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not Indagis Desktop. If it serves Hermes/Desktop UI or another unrelated app, stop that process and report failure.",
