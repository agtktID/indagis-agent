...
``~/.hermes/logs/`` (profile-aware via ``get_indagis_home()``).
...
from hermes_constants import get_config_path, get_indagis_home
...
def setup_logging(
    ...
    *force* is ``True``.
    ...
    hermes_home
        ...
        ``get_indagis_home()`` (profile-aware).
    log_level
    ...
    home = hermes_home or get_indagis_home()
    log_dir = home / "logs"
