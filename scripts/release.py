...
LEGACY_AUTHOR_MAP = {
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level INDAGIS_HOME for pid/lock/status identity files; #56986)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (INDAGIS_HOME inject)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level INDAGIS_HOME state files)
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/agtktID/indagis-agent",
