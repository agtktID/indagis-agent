...
#   2. ~/.indagis/node/ from a prior Hermes-managed install
#   3. fnm, proto, nvm (in that order) if the user already uses a version manager
#   4. Termux `pkg`, macOS Homebrew
#   5. pinned nodejs.org tarball into ~/.indagis/node/ (always works, zero shell rc edits)
#
# Usage:
...
#   INDAGIS_HOME               (default: $HOME/.indagis)
# ============================================================================
