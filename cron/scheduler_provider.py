...
class InProcessCronScheduler(CronScheduler):
    ...
    def start(
        ...
        *,
        ...
        # only the process-global INDAGIS_HOME (the default profile) is ticked.
    ...
    def _start_multiplex(
        ...
        *,
        ...
        Each profile uses ``set_indagis_home_override()`` + ``use_cron_store()``
        ...
        for entry in profile_homes:
            ...
            home_token = set_indagis_home_override(str(home))
            try:
