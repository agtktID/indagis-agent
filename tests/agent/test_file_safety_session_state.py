...
def fake_homes(tmp_path, monkeypatch):
    """Point INDAGIS_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_indagis_home /
    get_default_indagis_root) instead of monkeypatching private helpers —
    ...
    INDAGIS_HOME=<root>/profiles/<name> makes get_default_indagis_root()
