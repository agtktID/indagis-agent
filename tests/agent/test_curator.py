...
def curator_env(tmp_path, monkeypatch):
    """Isolated INDAGIS_HOME + freshly reloaded curator + skill_usage modules."""
    ...
    # save_state() resolves the state path from INDAGIS_HOME at write time, so a
    ...
    # thread here, while INDAGIS_HOME is still pinned to this test's tmp home
