...
Verifies that:
 ...
 2. User plugins at $INDAGIS_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    # Point INDAGIS_HOME at a fresh temp dir
    hermes_home = tmp_path / ".hermes"
    hermes_home.mkdir()
    monkeypatch.setenv("INDAGIS_HOME", str(hermes_home))
    # get_indagis_home() may be module-cached depending on codebase; ensure the
