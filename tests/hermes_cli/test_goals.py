...
def hermes_home(tmp_path, monkeypatch):
    """Isolated INDAGIS_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves INDAGIS_HOME.
