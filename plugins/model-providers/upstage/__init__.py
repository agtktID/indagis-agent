...
# When the user hasn't picked a reasoning effort, Indagis passes
...
# ON at this effort — matching the "medium (default)" that Indagis' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Indagis' effort vocabulary onto Solar's accepted set. xhigh/max/
