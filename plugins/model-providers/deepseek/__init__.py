...
the contract that subsequent turns echo it back; combined with how Indagis
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Indagis remaps
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Indagis, so they are not listed here.
    """
