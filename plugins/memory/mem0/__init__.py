...
Configuration
-------------
Secret (lives in $INDAGIS_HOME/.env or the environment):
...
Behavioral settings (live in $INDAGIS_HOME/mem0.json, set via `indagis memory
setup`):
  ...
  agent_id           — Agent identifier (default: indagis)
...
def _load_config() -> dict:
    """Load config from env vars, with $INDAGIS_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "indagis"),
        "oss": {},
    }
    ...
    config_path = get_indagis_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hermes_home):
        """Write config to $INDAGIS_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $INDAGIS_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "indagis")
