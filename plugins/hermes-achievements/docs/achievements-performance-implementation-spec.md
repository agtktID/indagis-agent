# Indagis Achievements Implementation Spec (Detailed)
...
Storage path:
- `~/.indagis/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.indagis/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.indagis/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.indagis/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.indagis/plugins/hermes-achievements/scan_checkpoint.json` (new)
