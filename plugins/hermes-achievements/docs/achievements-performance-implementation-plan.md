# Indagis Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.indagis/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.indagis/plugins/hermes-achievements/scan_checkpoint.json`.
