...
class TelegramAdapter(BasePlatformAdapter):
    ...
    # older PTB/clients. Streaming edits stay on Indagis' existing MarkdownV2
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        Indagis must skip rich delivery up front and use the legacy MarkdownV2
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `indagis update` or `--replace` handoffs)
        ...
        message = (
            ...
            "To recover: ensure no other Indagis or OpenClaw instance is running "
            "with this token, then restart the gateway with 'indagis gateway restart'."
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # payload size limit (~4KB total).  Indagis defaults to 60 to
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # readable by the Indagis process (shared mount, same machine, etc.).
    ...
    def _build_provider_keyboard(self, providers: list, page: int = 0) -> tuple:
        ...
        CLI ``indagis model`` picker via the shared ``group_providers`` fold,
    ...
    # Scripts live in ~/.indagis/scripts/gmail-triage/. `arg` from the callback
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Indagis bot profiles. A message like
    ...
    def _is_own_message(self, message: Message) -> bool:
        ...
        counted as incoming unread messages in the Indagis inbox.
        """
        if not self._bot:
            return False
    ...
    def _should_process_message(self, message: Message, *, is_command: bool = False) -> bool:
        ...
        # unread in the Indagis inbox (#52363).
        #
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `indagis setup` to install Telegram support.",
