...
Config: ~/.indagis/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.indagis/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_indagis_home()`` helper (INDAGIS_HOME-aware and
...
RULES_FILE = get_indagis_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_indagis_home() / "feishu_comment_pairing.json"
