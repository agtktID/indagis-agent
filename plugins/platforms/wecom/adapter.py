...
_QR_CODE_PAGE = "https://work.weixin.qq.com/ai/qc/gen?source=indagis&scode="
...
def qr_scan_for_bot_info(
    *,
    ...
    generate_url = f"{_QR_GENERATE_URL}?source=indagis"
...
def interactive_setup() -> None:
    ...
    if allowed:
        ...
        if access_idx == 0:
            ...
            print_info("Approve with: indagis pairing approve <platform> <code>")
        elif access_idx == 2:
            save_env_value("WECOM_DM_POLICY", "disabled")
            print_warning("Direct messages disabled.")
        else:
            print_info("Skipped — configure later with 'indagis gateway setup'")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `indagis setup` to install WeCom support.",
