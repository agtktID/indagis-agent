"""
Microsoft Teams platform adapter for Indagis Agent.
...
def _suppress_third_party_dotenv() -> Iterator[None]:
    ...
    Indagis owns dotenv loading; third-party import side effects must not.
    """
    try:
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Indagis"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Indagis\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.indagis/.env")
