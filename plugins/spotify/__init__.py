...
``_check_spotify_available()`` — when the user has not run ``indagis auth
spotify``, the tools remain registered (so they appear in ``indagis
...
The Spotify auth flow (``indagis auth spotify``), CLI plumbing, and docs
