 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of Indagis Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/agtktID/indagis-agent/${ref}/scripts/${scriptName}`
