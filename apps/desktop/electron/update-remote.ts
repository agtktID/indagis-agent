 ...
 *
 * A public install can end up with `origin=git@github.com:agtktID/indagis-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/agtktID/indagis-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/agtktid/indagis-agent'
