...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Indagis doesn't know how to remove it. */
...
// non-desktop) Indagis simply carries none of it. See store/profile-share.ts.
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Indagis, 'hub' = installed. */
 ...
 *  not Indagis); elsewhere, driver health from `cua-driver doctor`. `null`
