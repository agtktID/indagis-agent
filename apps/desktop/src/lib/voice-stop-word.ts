...
//
// When someone is in a hands-free "Hey Indagis" voice chat, the natural way to
...
// phrase (optionally addressed to Indagis), so a real turn that merely contains
 ...
 * to Indagis). Returns false for anything that merely contains "stop" as part of
