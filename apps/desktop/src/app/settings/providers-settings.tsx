...
function ConnectedProviderRow({
  ...
  // Indagis can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Indagis can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Indagis never deletes creds another tool owns behind a silent API call.
