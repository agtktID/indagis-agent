...
const OPTIONS: ModeOption[] = [
  ...
  },
  {
    ...
    consequence: 'the Chat GUI and the Indagis agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Indagis agent, and all of your config, chats, secrets, and logs',
