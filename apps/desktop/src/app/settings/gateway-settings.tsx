...
// Indagis Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // --- Indagis Cloud (cloud mode) state ---
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* Indagis Cloud panel: one portal sign-in, then a discovered-agent picker
