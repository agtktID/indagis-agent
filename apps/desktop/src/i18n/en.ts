...
export const en: Translations = {
  ...
  boot: {
    ready: 'Indagis Desktop is ready',
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'Indagis background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Indagis backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Indagis',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Indagis Desktop.',
    ...
    native: {
      ...
      inputBody: 'Indagis is waiting for your response.',
      turnDoneTitle: 'Indagis finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Indagis defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Indagis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Indagis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Indagis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Indagis was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Indagis follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Indagis can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Indagis is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Indagis, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Indagis checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Indagis configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Indagis.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive an Indagis backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Indagis backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Indagis backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Indagis Cloud',
      cloudDesc: 'Sign in once to Indagis Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Indagis Cloud',
      cloudSignIn: 'Sign in to Indagis Cloud',
      cloudSignedIn: 'Signed in to Indagis Cloud',
      cloudNeedsSignIn: 'Sign in to Indagis Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Indagis Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Indagis Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Indagis Cloud',
      cloudSignedOutMessage: 'Cleared the Indagis Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /indagis.',
      ...
      restartingMessage: 'Indagis Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Indagis ${version}` : ''}`,
      ...
      sshDesc:
        'Indagis is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Indagis path (optional)',
      sshHermesPathDesc: 'Full path to the remote indagis binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Indagis found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Indagis runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Indagis on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Indagis runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Indagis at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via indagis curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Indagis builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Indagis to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Indagis to generate pets.',
      backgroundHint: 'You can close this — Indagis will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Indagis desktop' },
    ...
    hermesActiveSessions: (version, count) => `Indagis ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@indagis:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Indagis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Indagis will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Indagis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Indagis. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Indagis...',
    placeholderReconnecting: 'Reconnecting to Indagis…',
    ...
    attachUrlDesc: 'Indagis will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Indagis to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Indagis…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Indagis…',
    ...
    unsupportedMessage: 'This version of Indagis can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Indagis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Indagis will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Indagis desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Indagis updater takes over in its own window and reopens Indagis automatically when it’s done. Please don’t reopen Indagis yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Indagis reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Indagis reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Indagis needs a one-time install',
    ...
    installLocalTitle: 'Install Indagis locally',
    installLocalDesc: 'Download Indagis, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Indagis Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Indagis',
    remoteSetupDesc: 'Enter your gateway URL. Indagis Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Indagis gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/indagis',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Indagis gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Indagis Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Indagis CLI or desktop instance is running. Stop any running Indagis instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Indagis installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Indagis Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Indagis is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Indagis…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Indagis',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Indagis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Indagis connects automatically',
    ...
    authorizeThere: 'Authorize Indagis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Indagis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Indagis Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Indagis Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Indagis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Indagis is restarting...',
      askRestart: 'Ask Indagis to restart the server',
      lookingRestart: taskId => `Indagis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Indagis is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Indagis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Indagis could not restart the server.',
      stillWorking:
        'Indagis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Indagis is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Indagis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.indagis/config.yaml). Indagis won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Indagis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Indagis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Indagis Desktop to use Save Image.',
    restartToSaveImages: 'Restart Indagis Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `indagis gateway` running?'
    }
  },
