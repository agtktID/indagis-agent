...
sidebar_position: 10
description: "Bundled Skills Catalog"
---
...
| [`indagis-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-indagis-agent) | Use, configure, theme, extend, and orchestrate Indagis Agent. | `autonomous-ai-agents/indagis-agent` |
...
| [`indagis-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-indagis-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/indagis-agent-skill-authoring` |
