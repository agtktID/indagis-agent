...
description: "Reference for Indagis Agent MCP configuration keys, filtering semantics, and utility-tool policy"
---
...
Behavior:
- Indagis uses the MCP SDK's OAuth 2.1 PKCE flow (metadata discovery, dynamic client registration, token exchange, and refresh)
