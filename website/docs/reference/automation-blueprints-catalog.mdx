---
id: automation-blueprints-catalog
title: "Automation Blueprints Catalog"
sidebar_position: 1
description: "Automation Blueprints Catalog"
---
...
of fields, and Indagis schedules it as a cron job — no cron syntax required.
...
- **CLI, TUI, and messengers** — type `/blueprint <name>` (e.g.
  `/blueprint morning-brief`) and Indagis asks you for what it needs, one
