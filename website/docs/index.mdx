...
description: "An AI workspace for cybersecurity investigation with a closed learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
**Indagis Agent is an AI workspace for cybersecurity investigation** — OSINT, threat intel, and DFIR. It has a closed learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
To easily install the command-line and desktop applications, [download the Indagis Desktop installer](https://github.com/agtktID/indagis-agent) from our website and run it.
...
- **Use any model you want** — OpenRouter, OpenAI, your own endpoint, and many others. Switch providers with `indagis model` — no code changes, no lock-in
