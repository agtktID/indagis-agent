...
description: "Complete guide to migrating your OpenClaw / Clawdbot setup to Indagis Agent — what gets migrated, how config maps, and what to check after."
---
...
:::tip
If your OpenClaw setup was multi-provider, `indagis setup --portal` collapses it to one OAuth — 300+ models plus the Tool Gateway in a single login. See [Nous Portal](/integrations/nous-portal).
:::
