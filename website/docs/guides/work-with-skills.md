...
description: "Find, install, use, and create skills — on-demand knowledge that teaches Indagis new workflows"
---
...
For how to ship skills in your own plugin, see [Build an Indagis Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
