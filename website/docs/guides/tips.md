...
description: "Practical advice to get the most out of Indagis Agent — prompt tips, CLI shortcuts, context files, memory, cost optimization, and security"
---
...
Run `indagis setup --portal` — you get 300+ models including Claude, GPT-5, and Gemini under one subscription. See [Nous Portal](/integrations/nous-portal).
:::
...
Want Indagis to have a stable default voice? Edit `~/.indagis/SOUL.md` (or `$INDAGIS_HOME/SOUL.md` if you use a custom Indagis home). Indagis now seeds a starter SOUL automatically and uses that global file as the instance-wide personality source.

For a full walkthrough, see [Use SOUL.md with Indagis](/guides/use-soul-with-hermes).
