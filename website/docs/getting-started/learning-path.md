...
First-time users almost always want `indagis setup --cloud` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Indagis Cloud](/integrations/indagis-portal).
:::
...
7. [Use Voice Mode with Indagis](/guides/use-voice-mode-with-indagis)
