...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/finance/3-statement-model` |
...
See [references/formulas.md](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/finance/3-statement-model/references/formulas.md) for all formula details.
