...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + Indagis Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This Indagis skill mirrors that guidance for Indagis.)
