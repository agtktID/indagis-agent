...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing indagis tool access (web_search, file ops). Stateless. |
