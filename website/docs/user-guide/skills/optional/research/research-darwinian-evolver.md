...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Indagis Agent |
| License | MIT |
...
import upstream classes into Indagis itself.
...
Open `~/.indagis/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Indagis core.
   Custom driver scripts under `~/.indagis/skills/...` are user-side and fine.
