...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/research/qmd` |
...
Indagis Agent via the native MCP client. This is the preferred
...
Then configure Indagis Agent to connect via HTTP:
