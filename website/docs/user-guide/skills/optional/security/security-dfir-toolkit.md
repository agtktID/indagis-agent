---
title: "Dfir Toolkit"
sidebar_label: "Dfir Toolkit"
description: "Memory and disk forensic triage using Volatility3 (memory image analysis) and The Sleuth Kit (disk image analysis) — process/network/injection artifacts from..."
---
...
Memory and disk forensic triage using Volatility3 (memory image analysis) and The Sleuth Kit (disk image analysis) — process/network/injection artifacts from a RAM capture, and partition/file-level artifacts from a disk image, logged into an evidence-store.py investigation.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `indagis skills install official/security/dfir-toolkit` |
| Path | `optional-skills/security/dfir-toolkit` |
| Version | `1.0.0` |
| Author | Indagis Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `dfir`, `memory-forensics`, `disk-forensics`, `volatility`, `sleuthkit`, `incident-response` |
| Related skills | [`oss-forensics`](/docs/user-guide/skills/optional/security/security-oss-forensics) |
...
[plugin-cheatsheet.md](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/security/dfir-toolkit/references/plugin-cheatsheet.md) for the full
cross-OS plugin map.
...
- [plugin-cheatsheet.md](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/security/dfir-toolkit/references/plugin-cheatsheet.md) — full
  Volatility3 plugin map (Windows/Linux/macOS) and Sleuth Kit command
  reference.
- [evidence-store.py](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/security/dfir-toolkit/../oss-forensics/scripts/evidence-store.py) — the
