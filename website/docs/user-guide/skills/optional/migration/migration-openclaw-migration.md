...
- migrate Indagis-compatible messaging settings such as `TELEGRAM_ALLOWED_USERS`, and map OpenClaw workspace settings to Indagis working-directory configuration
...
With `--migrate-secrets`, it will also import a small allowlisted set of Indagis-compatible secrets, currently:
