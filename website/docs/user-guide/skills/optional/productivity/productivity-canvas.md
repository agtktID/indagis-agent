...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Indagis Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${INDAGIS_HOME:-~/.indagis}/.env`:
