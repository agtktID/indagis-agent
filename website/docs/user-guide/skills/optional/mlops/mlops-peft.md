...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/agtktID/indagis-agent/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
