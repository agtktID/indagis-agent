...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/health/neuroskill-bci` |
...
Connect Indagis to a running [NeuroSkill](https://neuroskill.com/) instance to read
