...
| | |
|---|---|
| Source | Optional — install with `indagis skills install official/web-development/page-agent` |
...
- User wants **Indagis itself to drive a browser** → use Indagis' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
