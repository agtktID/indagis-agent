...
sidebar_label: "Virustotal Lookup"
...
Look up file hashes, URLs, domains, and IPs on VirusTotal for AV-engine verdicts, reputation, and relationship data.
...
| Path | `skills/security/virustotal-lookup` |
| Version | `1.0.0` |
| Author | Indagis Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `threat-intel`, `malware`, `reputation`, `virustotal`, `ioc`, `file-analysis` |
| Related skills | [`shodan-search`](/docs/user-guide/skills/bundled/security/security-shodan-search), [`misp-query`](/docs/user-guide/skills/optional/security/security-misp-query), [`yara-scan`](/docs/user-guide/skills/bundled/security/security-yara-scan) |
