...
Set your Tenor API key in your environment (add to `${HERMES_HOME:-~/.indagis}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/agtktID/indagis-agent/blob/main/skills/media/gif-search/url)`
