...
For Indagis itself, `model.provider: openai-codex` uses Indagis-managed Codex
...
When invoking the Codex CLI from a Indagis gateway/service context (for example,
