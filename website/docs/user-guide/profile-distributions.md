...
hermes profile install ~/.indagis/profiles/research-bot --name research-bot-test --alias

# Tweak, delete, re-install until it's right
hermes profile delete research-bot-test --yes
hermes profile install ~/.indagis/profiles/research-bot --name research-bot-test
```
