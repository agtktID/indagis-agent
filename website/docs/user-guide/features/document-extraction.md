...
sidebar_position: 16
description: "The `read_file` tool automatically converts common document formats to readable text, so the agent can inspect a PDF or spreadsheet the same way it…"
---
