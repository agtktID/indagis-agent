...
| Platform | Prereqs |
|---|---|
| **macOS** | System Settings → Privacy & Security → **Accessibility** + **Screen Recording** → allow your terminal (or Indagis app). `indagis computer-use doctor` will tell you which permission is missing. |
