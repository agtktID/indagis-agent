...
description: "Build themes and plugins for the Indagis web dashboard — palettes, typography, layouts, custom tabs, shell slots, page-scoped slots, and backend API routes"
---
