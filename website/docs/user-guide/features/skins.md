...
sidebar_position: 10
title: "Skins & Themes"
description: "Customize the Indagis CLI with built-in and user-defined skins"
---
...
Indagis Mod respects the `INDAGIS_HOME` environment variable, so it works with [profiles](/user-guide/profiles) too.
