...
| Nous Portal | `nous` | `indagis setup --portal` (fresh) or `indagis auth add nous` (OAuth) |
| OpenAI Codex | `openai-codex` | `indagis model` (ChatGPT OAuth) |
...
| `"codex"` | Force Codex OAuth | `indagis model` → Codex |
