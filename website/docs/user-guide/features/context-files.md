...
Indagis Agent automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Indagis instance and is loaded from `INDAGIS_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Indagis instance | `INDAGIS_HOME/SOUL.md` only |
...
- `~/.indagis/SOUL.md`
- or `$INDAGIS_HOME/SOUL.md` if you run Indagis with a custom home directory
