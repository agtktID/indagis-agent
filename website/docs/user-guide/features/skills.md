...
```bash
curl -fsSL https://raw.githubusercontent.com/agtktID/indagis-agent/main/scripts/install.sh | bash -s -- --no-skills
```
...
[Skills Hub](https://github.com/agtktID/indagis-agentdocs) page — instead of a
