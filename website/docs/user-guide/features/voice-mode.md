...
:::tip
The `~/.indagis/` directory and default `config.yaml` are created automatically the first time you run `hermes`. You only need to create `~/.indagis/.env` manually for API keys.
:::
