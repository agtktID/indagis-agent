...
sidebar_position: 10
title: "Voice Mode"
description: "Real-time voice conversations with Indagis Agent — CLI, Telegram, Discord (DMs, text channels, and voice channels)"
---
...
If you want a practical setup walkthrough with recommended configurations and real usage patterns, see [Use Voice Mode with Indagis](/guides/use-voice-mode-with-hermes).
...
A paid [Nous Portal](/user-guide/features/tool-gateway) subscription supplies the LLM (step 2) **and** OpenAI TTS via the Tool Gateway — no separate OpenAI key needed. On a fresh install, `indagis setup --portal` wires both up at once.
:::
