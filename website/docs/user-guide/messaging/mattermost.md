...
sidebar_position: 8
title: "Mattermost"
description: "Set up Indagis Agent as a Mattermost bot"
---
...
No external Mattermost library is required — the adapter uses `aiohttp`, which is already an Indagis dependency.
...
3. Search for your bot username (e.g., `indagis`) and add it.
