...
sidebar_position: 4
title: "Slack"
description: "Set up Indagis Agent as a Slack bot using Socket Mode"
---
...
[`COMMAND_REGISTRY`](https://github.com/agtktID/indagis-agent/blob/main/hermes_cli/commands.py)
...
`/hermes btw run the tests` — Indagis routes it the same way as `/btw
