...
title: "SimpleX Chat"
sidebar_position: 1
description: "SimpleX Chat is a private, decentralised messaging platform where users own their contacts and groups. Unlike other platforms, SimpleX assigns no p..."
---
# SimpleX Chat
...
- The connection between Indagis and the daemon is local WebSocket (`ws://127.0.0.1:5225`) — no data leaves your machine
