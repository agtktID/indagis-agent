...
sidebar_position: 1
description: "Chat with Indagis from Telegram, Discord, Slack, WhatsApp, Signal, SMS, Email, Home Assistant, Mattermost, Matrix, DingTalk, Feishu/Lark, WeCom, Wei..."
---
# Messaging Gateway

Chat with Indagis from Telegram, Discord, Slack, WhatsApp, Signal, SMS, Email, Home Assistant, Mattermost, Matrix, DingTalk, Feishu/Lark, WeCom, Weixin, BlueBubbles (iMessage), QQ, Yuanbao, Microsoft Teams, LINE, ntfy, or your browser. The gateway is a single background process that connects to all your configured platforms, handles sessions, runs cron jobs, and delivers voice messages.

For the full voice feature set — including CLI microphone mode, spoken replies in messaging, and Discord voice-channel conversations — see [Voice Mode](/user-guide/features/voice-mode) and [Use Voice Mode with Indagis](/guides/use-voice-mode-with-indagis).

:::tip
Bots need both a model provider and tool providers (TTS, web). A [Indagis Cloud](/integrations/indagis-cloud) subscription bundles all of them.
:::
...
`platforms.<name>.enabled: false` in `~/.indagis/config.yaml` is authoritative.
