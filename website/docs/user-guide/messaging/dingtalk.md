...
sidebar_position: 10
title: "DingTalk"
description: "Set up Indagis Agent as a DingTalk chatbot"
---
...
```bash
cd ~/.indagis/hermes-agent && uv pip install -e ".[dingtalk]"
```
