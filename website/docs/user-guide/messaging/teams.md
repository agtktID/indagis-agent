...
description: "Set up Indagis Agent as a Microsoft Teams bot"
---
...
| Teams shows "This bot is not responding" | The webhook returned an error. Check `docker logs indagis` for tracebacks |
