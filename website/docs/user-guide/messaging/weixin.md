...
sidebar_position: 15
title: "Weixin (WeChat)"
description: "Connect Indagis Agent to personal WeChat accounts via the iLink Bot API"
---
...
| Terminal QR code doesn't render | Reinstall with the messaging extra: `cd ~/.indagis/hermes-agent && uv pip install -e ".[messaging]"`. Alternatively, open the URL printed above the QR |
