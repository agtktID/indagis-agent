...
description: "Build wrapper CLIs that extend the Indagis TUI with custom widgets, keybindings, and layout changes"
---

# Extending the CLI

Indagis exposes protected extension hooks on `HermesCLI` so wrapper CLIs can add widgets, keybindings, and layout customizations without overriding the 1000+ line `run()` method. This keeps your extension decoupled from internal changes.
