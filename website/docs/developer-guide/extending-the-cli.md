---
id: extending-the-cli
title: "Extending the CLI"
sidebar_position: 1
description: "Indagis exposes protected extension hooks on IndagisCLI so wrapper CLIs can add widgets, keybindings, and layout customizations without overriding th..."
---
# Extending the CLI

Indagis exposes protected extension hooks on `IndagisCLI` so wrapper CLIs can add widgets, keybindings, and layout customizations without overriding the 1000+ line `run()` method. This keeps your extension decoupled from internal changes.
...
```python
#!/usr/bin/env python3
"""my_cli.py — Example wrapper CLI that extends Indagis."""

from cli import IndagisCLI
from prompt_toolkit.layout import FormattedTextControl, Window
from prompt_toolkit.filters import Condition


class MyCLI(IndagisCLI):
...
Called after Indagis registers its own keybindings and before the layout is built. Add your keybindings to `kb`.
