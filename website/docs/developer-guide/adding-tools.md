...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Indagis Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Indagis tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Indagis core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build an Indagis Plugin](/developer-guide/plugins)
...
- [ ] Tested with `indagis chat -q "Use the weather tool for London"`
