...
sidebar_position: 1
description: "Indagis deliberately separates:"
---
# Prompt Assembly
...
You are Indagis, an AI assistant created by Indagis Labs.
...
```
You are Indagis Agent, built by Indagis Labs. Be direct: match the length
