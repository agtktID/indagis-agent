...
description: "How the iron-proxy egress firewall integrates with Indagis — module layout, lifecycle, security invariants, and extension points"
---
...
INDAGIS_HOME=/tmp/hermes-egress-test python3 -m hermes_cli.main egress --help
INDAGIS_HOME=/tmp/hermes-egress-test python3 -m hermes_cli.main egress setup --help
```
...
- Bitwarden Secrets Manager integration: [`indagis secrets bitwarden`](https://hermes-agent.nousresearch.com/docs/user-guide/secrets/bitwarden)
- CLI command reference: [`indagis egress`](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-egress)
