...
description: "How to build a memory provider plugin for Indagis Agent"
---
...
class MyMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always includes:
          hermes_home (str): Active INDAGIS_HOME path. Use for storage.
        """
...
All storage paths **must** use the `hermes_home` kwarg from `initialize()`, not hardcoded `~/.indagis`:
