...
title: "Tools Runtime"
sidebar_position: 1
description: "Indagis tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system."
---
# Tools Runtime

Indagis tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Indagis resolves them through:
