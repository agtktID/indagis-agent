...
| | |
|---|---|
| 来源 | 可选 — 使用 `indagis skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Indagis Agent |
| 许可证 | MIT |
...
```
SCRIPT=~/.indagis/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.indagis/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
