...
SITE_BASE = "https://github.com/agtktID/indagis-agentdocs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> An AI workspace for cybersecurity investigation. A terminal-native "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/agtktID/indagis-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/agtktID/indagis-agentdocs\n",
        "Short index: /docs/llms.txt\n",
        "\n---\n\n",
    ]
