...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Indagis Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "tool_prefix": "┊",
        # Braille-art rendition of the diamond/hexagon mark from
        # assets/indagis-banner.png, generated by sampling the source PNG
        # (see the conversion script in the PR that added this) rather than
        # hand-drawn, so it stays a faithful mini version of the real logo.
        "banner_hero": """[#37D5D6]⠀⠀⠀⠀⠀⠀⠀⠀⠴⠚⠉⠓⣦⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]
[#37D5D6]⠀⠀⠀⢀⡠⠆⠀⠀⠀⠀⠀⠀⠀⠑⠢⠴⢄⡀⠀⠀⠀⠀⠀[/]
[#37D5D6]⠀⠀⠀⡏⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢹⠀⠀⠀⠀⠀[/]
[#37D5D6]⠀⠀⠀⡇⠀⠀⠀⣠⣤⣤⣤⡤⣤⣤⠀⠀⠀⢸⠀⠀⠀⠀⠀[/]
