...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Indagis to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Indagis needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Indagis gateway in another terminal:")
    print("         indagis gateway")
    print()
    ...
    print()
    print("  Docs: https://agtktid.github.io/docs/user-guide/")
