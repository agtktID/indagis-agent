    ...
    if new_value == "codex_app_server":
        ...
        try:
            ...
            if "hermes-tools" in mig_report.migrated:
                msg_lines.append(
                    "Indagis tool callback registered: codex can now use "
                ...
                msg_lines.append(
                    ...
                    "only on the default Indagis runtime — they need the "
                    "agent loop context.)"
                )
        ...
        msg_lines.append(
            ...
            "Indagis tools available via MCP callback)."
        )
        msg_lines.append(
        ...
        msg_lines.append("OpenAI/Codex turns will use the default Indagis runtime.")
