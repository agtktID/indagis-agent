...
_HERMES_MODEL_WARNING = (
    "Nous Research Indagis 3 & 4 models are NOT agentic and are not designed "
    "for use with Indagis Agent. They lack the tool-calling capabilities "
    ...
    if explicit_provider:
        ...
        if pdef is None:
            _switch_err = (
                ...
                f"Check 'indagis model' for available providers, or define it "
            ...
            try:
                ...
                if _cfg_issues:
                    _switch_err += "\n\nRun 'indagis doctor' — config issues detected:"
