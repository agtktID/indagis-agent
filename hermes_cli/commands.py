...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("intel", "Threat-intel lookups — AbuseIPDB, GreyNoise, OTX, MalwareBazaar, crt.sh, CISA KEV/EPSS", "Tools & Skills",
               cli_only=True, args_hint="[subcommand]",
               subcommands=("sources", "abuseipdb", "greynoise", "otx", "malwarebazaar", "crtsh", "kev")),
