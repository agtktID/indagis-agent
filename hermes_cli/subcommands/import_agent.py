...
def build_import_agent_parser(subparsers, *, cmd_import_agent: Callable) -> None:
    ...
    parser = subparsers.add_parser(
        "import-agent",
        help="Import a Claude Code or Codex CLI setup into Indagis",
        description=(
            "One-command import of another coding agent's setup into Indagis. "
    ...
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Overwrite existing Indagis items on name conflicts (default: skip)",
    )
    parser.add_argument(
