...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Indagis Teal",         "description": "Classic dark teal — the canonical Indagis look"},
    {"name": "default-large", "label": "Indagis Teal (Large)", "description": "Indagis Teal with bigger fonts and roomier spacing"},
