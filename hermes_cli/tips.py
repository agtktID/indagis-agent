...
TIPS = [
    ...
    "indagis mcp serve runs Hermes itself as an MCP server for other agents.",
    ...
    "indagis backup creates a zip backup of your entire Hermes home directory.",
    ...
    "indagis gateway install sets up Hermes as a system service (systemd/launchd).",
    ...
    "indagis acp runs Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "Profiles scope Hermes state via INDAGIS_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'indagis dashboard embeds the full Hermes TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'indagis import restores a full Hermes backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
