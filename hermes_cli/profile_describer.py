...
_SYSTEM_PROMPT = """You are a profile-describer for the Indagis Agent kanban board.
...
Rules:
  ...
  - Never write "Indagis Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_indagis_home())
        else:
