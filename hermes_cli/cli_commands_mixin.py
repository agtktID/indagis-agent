...
from hermes_constants import display_indagis_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_indagis_home()}/state-snapshots/):\n")
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Indagis-managed isolated debug "
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_indagis_home()}/skins/\n")
            return
    ...
    def _handle_update_command(self) -> bool:
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Indagis Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Indagis Agent"),
