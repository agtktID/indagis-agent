...
| `hermes honcho sync` | Create host blocks for all Indagis profiles that don't have one yet |
| `hermes honcho migrate` | Step-by-step migration guide from OpenClaw native memory to Indagis + Honcho |
