---
name: mitm-traffic-audit
description: Comprehensive security audit of mitmproxy-captured traffic across 8 vulnerability categories (recon, auth/session, IDOR, SQLi, SSRF, data exposure, payment/business logic, transport/headers). Use after mitm-traffic-capture has produced a log.txt.
version: 1.0.0
...
metadata:
  hermes:
    ...
    category: security
    related_skills: [mitm-traffic-capture, web-pentest, yara-scan]
---
