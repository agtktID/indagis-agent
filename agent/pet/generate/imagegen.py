...
def _forced_provider_from_env() -> str | None:
    ...
    """
    forced = env_with_legacy_alias("INDAGIS_PET_IMAGE_PROVIDER", "HERMES_PET_IMAGE_PROVIDER", "").strip().lower()
...
def resolve_provider(*, require_references: bool = True, prefer: str | None = None) -> SpriteProvider:
    ...
    raise GenerationError(
        ...
        "Open `indagis tools` → Image Generation and configure Nous Portal, "
