...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Indagis, e.g. 'hermes-agent').\n"
    "  • Hub-installed skills (installed via 'indagis skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'indagis curator pin'). You are an "
    ...
    "'indagis curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'indagis skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'indagis curator pin'). Pin blocks "
    ...
    "reply and recommend 'indagis curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or env_with_legacy_alias("INDAGIS_SESSION_SOURCE", "HERMES_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
