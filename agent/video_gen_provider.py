...
def _videos_cache_dir() -> Path:
    """Return ``$INDAGIS_HOME/cache/videos/``, creating parents as needed."""
    from hermes_constants import get_indagis_home

    path = get_indagis_home() / "cache" / "videos"
...
def save_b64_video(
    ...
    *,
    ...
    """Decode base64 video data and write under ``$INDAGIS_HOME/cache/videos/``.
...
def save_url_video(
    ...
    *,
    ...
    """Download a video URL and write it under ``$INDAGIS_HOME/cache/videos/``.
