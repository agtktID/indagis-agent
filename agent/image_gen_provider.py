...
def _images_cache_dir() -> Path:
    """Return ``$INDAGIS_HOME/cache/images/``, creating parents as needed."""
    from hermes_constants import get_indagis_home

    path = get_indagis_home() / "cache" / "images"
...
def save_b64_image(
    ...
    *,
    ...
    """Decode base64 image data and write it under ``$INDAGIS_HOME/cache/images/``.
...
def save_url_image(
    ...
    *,
    ...
    """Download an image URL and write it under ``$INDAGIS_HOME/cache/images/``.
